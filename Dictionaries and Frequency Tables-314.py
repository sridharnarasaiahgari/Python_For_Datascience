...
for rec in content_ratings:
    proportion = content_ratings[rec] / total_number_of_apps
    c_ratings_proportions[rec] = proportion
    c_ratings_percentages[rec] = proportion * 100
